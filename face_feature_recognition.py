...
faces_folder_path = 'prashant/'

# Globals
face_detector = dlib.get_frontal_face_detector()
shape_predictor = dlib.shape_predictor('dlib_data/shape_predictor_68_face_landmarks.dat')
face_recognition_model = dlib.face_recognition_model_v1('dlib_data/dlib_face_recognition_resnet_model_v1.dat')
...
def recognize_faces_in_video(face_encodings, person_names):
    faceClassifier = cv2.CascadeClassifier('haarcascade/haarcascade_frontalface_default.xml')
